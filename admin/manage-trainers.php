        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card-modern">
              <div class="card-body">
                <div class="card-modern-header"><h3>Management of School Trainers</h3></div>
                ...
                <table class="table datatable table table-borderless datatable">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><?php echo $call['FirstName'] ?> </td>
                      <td><?php echo $call['LastName'] ?> </td>
                      <td><?php echo $call['Email'] ?></td>
                      <td><?php echo $call['Phone'] ?> </td>
                      <td><?php echo $call['CreationDate'] ?></td>
                      
                        <td align="center"><a href="deletecontents.php?deletetrainerid=<?php echo $call['id'] ?>"  class="btn-modern btn-modern-danger  d-grid gap-2 mt-3" onclick="return confirm('Are You Sure To Delete School Trainer')">Delete</a></td>
                    </tr>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (deleteSelectedBtn) {
      deleteSelectedBtn.addEventListener('click', function() {
        ...
        if (confirm('Are you sure you want to delete ' + selected.length + ' selected trainer(s)?')) {
          window.location.href = 'deletecontents.php?deletetrainerid=' + selected.join(',');
        }
      });
    }
  });
