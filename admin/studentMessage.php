        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card-modern">
              <div class="card-body">
                <div class="card-modern-header"><h3>Management of School Student Message</h3></div>
    ...
    <div class="row">
                ...
                <table class="table datatable table table-borderless datatable">
                  ...
                  <?php
                            ...
                            $sql = "SELECT * FROM `tbl_student_message`";
                            $result = mysqli_query($conn, $sql);
                            $count = 1;
                    ...
                    <tr>
                      ...
                      <td><?php echo $call['FullName'] ?> </td>
                      <td><?php echo $call['StudentLevel'] ?> </td>
                      <td><?php echo $call['StudentDepartment'] ?></td>
                      <td><?php echo $call['CreationDate'] ?> </td>
                      <td><?php echo $call['StudentMessage'] ?></td>
                      
                        <td align="center"><a href="deletecontents.php?deleteMessageId=<?php echo $call['id'] ?>"  class="btn-modern btn-modern-danger  d-grid gap-2 mt-3" onclick="return confirm('Are You Sure To Delete Student Message')">Delete</a></td>
                    </tr>
