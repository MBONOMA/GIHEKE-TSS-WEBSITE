...
if(isset($_POST['submit'])){
        ...
        include 'includes/connection.php';
                ...
                $sql = "INSERT INTO `tbl_works` (id,Level,Department,ModuleName, WorkDetails) VALUES ('', '$Level', '$Department','$Module', '$PostDetails') ";
                ...
                if($result){
                    ...
                    $msg = "School Work  Added Successfully";
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add School Works</h1>
      <nav>
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Add School Works</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <!-- Vertical Form -->
    <form class="row g-3 needs-validation" novalidate action="add-works.php" method="post">
...
$(document).ready(function(){
   ...
   <h5 class="m-b-30 m-t-0 header-title"><b>School Work Features</b></h3></div>
        ...
        <div class="col-12 position-relative">
            <label for="validationTooltip04" class="form-label">Select Module Level</label>
            <select class="form-modern" id="Level" required  name="Level">
              <option name="Level" selected disabled value="">Choose Level</option>
              <option name="Level" value="Level 3">Level 3</option>
              <option name="Level" value="Level 4">Level 4</option>
              <option name="Level" value="Level 5">Level 5</option>
            </select>
          ...
          <div class="col-12 position-relative">
            <label for="validationTooltip04" class="form-label">Select Module Department</label>
            <select class="form-modern" id="Department" required name="Department">
        ...
        <div class="col-12 position-relative">
            <label for="validationTooltip04" class="form-label">Select Module</label>
            <select class="form-modern" id="Modules" required  name="Module">
        ...
        <div class="text-center">
          <div class="d-grid gap-2 mt-3">
            <button class="btn-modern btn-modern-primary" name="submit" type="submit">Add Work</button>
          </div>
