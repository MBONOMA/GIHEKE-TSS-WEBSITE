...
if(isset($_POST['submit'])){
        ...
        $Email = $_POST['Email'];
        $PhoneNumber = "+250". $_POST['PhoneNumber'];
        $Imageurl = "DefaultImage.png";
        $Password = "trainer123";
        


      $sql = "INSERT INTO tbl_trainers
        (FirstName, LastName, Email, Phone, ImageUrl, Password)
        VALUES
        ...
        if($result = TRUE){
            ...
            $msg = "School Trainer Added Successfully";
      ...
      <div class="admin-content">
        <div class="admin-section-card">
          <div class="admin-section-header">
            <h3><i class="bi bi-plus-circle me-2" style="color:#525FE1;"></i>Add Trainer</h3>
          </div>
          <div class="p-3">
            <form class="row g-3 needs-validation" novalidate action = "add-trainers.php" method="post">
    ...
    <div class="row">
        ...
        <div class="col-12 position-relative">
          ...
          <label for="" class="form-label">First Name</label>
           ...
           <input type="text" class="form-modern"  name="FirstName" required placeholder="Enter Your First Name">
        ...
        <div class="col-12 position-relative">
          ...
          <label for="validationTooltip01" class="form-label">Last Name</label>
           ...
           <input type="text" class="form-modern" name="LastName"  id="validationTooltip01" required placeholder="Enter Your Last Name">
          <div class="valid-tooltip">
            Looks good!
          </div>    
          <div class="invalid-tooltip">
        ...
        <div class="col-12 position-relative">
          ...
          <label for="validationTooltip01" class="form-label">Email</label>
           ...
           <input type="email" class="form-modern" name="Email"  id="validationTooltip01" required placeholder="Enter Your Valid Email">
          <div class="valid-tooltip">
            Looks good!
          </div>    
          <div class="invalid-tooltip">
        ...
        <div class="col-12">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-modern" name="PhoneNumber" placeholder="000 000 000" required aria-label="Username" aria-describedby="basic-addon1">
        ...
        <div class="text-center">
          <div class="d-grid gap-2 mt-3">
            <button class="btn-modern btn-modern-primary" name="submit" onclick="validation()" type="submit">Add Trainer</button>
          </div>
