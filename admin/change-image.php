...
move_uploaded_file($_FILES["postimage"]["tmp_name"],"Blog Gallery/".$imgnewfile);
...
if($query)
{
    ...
    header("location:manage-blogpost.php?msg=Blog Image Updated Successfully");
}
else{
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <input type="text" class="form-modern" id="posttitle" value="<?php echo htmlentities($row['PostTitle']);?>" name="posttitle"  readonly>
      </div>
      <div class="row">
      <div class="col-sm-12">
      <div class="admin-section-card">
      <h4 style="margin-bottom:16px;"><b>Current Post Image</b></h4>
      <img src="Blog Gallery/<?php echo $row['PostImage'] ?>" width="300"/>
      <br /><br>
      </div>
      </div>
      </div>
